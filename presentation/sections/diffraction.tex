...
\begin{frame}{Beugungsintegral - Schlachtplan}
    \begin{columns}
        ...
        \begin{column}{0.8\textwidth}
            \begin{block}<2->{Allgemeines Beugungsintegral \hfill alle $l$}
                \begin{itemize}
                    \item Summierung vieler Einzelwellen
                \end{itemize}
            \end{block}
            \begin{block}<3->{Fresnel-Approximation \hfill grosse $l$}
                \begin{itemize}
                    \item Für kleine Winkel
                \end{itemize}
            \end{block}
            \begin{block}<4->{Fraunhofer-Approximation \hfill sehr grosse $l$}
                \begin{itemize}
